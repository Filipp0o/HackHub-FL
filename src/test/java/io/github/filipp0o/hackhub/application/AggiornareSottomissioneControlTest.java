...
class AggiornareSottomissioneControlTest {
    ...
    @Test
    void avviaAggiornamentoERestituisceContenutoCorrente() {
        Scenario scenario =
                creaScenario(
                        creaHackathonConScadenzaFutura()
                );

        String contenuto = scenario.control
    ...
    @Test
    void rifiutaUtenteOHackathonNulli() {
        Scenario scenario =
                creaScenario(
                        creaHackathonConScadenzaFutura()
                );
    ...
    @Test
    void rifiutaPartecipazioneEsclusa() {
        Scenario scenario =
                creaScenario(
                        creaHackathonConScadenzaFutura()
                );

        scenario.partecipazione.escludi();
    ...
    @Test
    void aggiornaESalvaSottomissione() {
        Scenario scenario =
                creaScenario(
                        creaHackathonConScadenzaFutura()
                );

        scenario.control.aggiornaSottomissione(
                scenario.utente,
                scenario.hackathon,
                "Versione aggiornata"
        );
    ...
    @Test
    void rifiutaSottomissioneAssente() {
        Scenario scenario =
                creaScenario(
                        creaHackathonConScadenzaFutura()
                );

        scenario.sottomissioneRepository.sottomissione =
                null;
